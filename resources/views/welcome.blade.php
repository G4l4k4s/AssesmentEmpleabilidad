...
-->
    <div
        ...
        <img src="https://wallpapers.com/images/hd/medical-background-cjge7e89adg6ub8x.jpg"
            class="absolute top-0 left-0 min-h-full ob" alt="">
        <div class="relative z-20 max-w-screen-lg mx-auto grid grid-cols-12 h-full items-center">
            <div class="col-span-6">
                ...
                <h1 class="text-white font-extrabold text-5xl mb-8">Find the way for the better atention in your healt
                </h1>
                ...
                <button
                    ...
                    <a href="{{ route('welcome.index') }}"
                        class="px-4 py-2 rounded-lg text-gray-800 dark:text-gray-200 hover:bg-blue-600 hover:text-white dark:hover:bg-blue-500 transition duration-300">
                        personal
                    </a></button>
            </div>
        </div>
